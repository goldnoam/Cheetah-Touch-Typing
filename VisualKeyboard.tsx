...
const VisualKeyboard: React.FC<VisualKeyboardProps> = ({ layout, activeKey, theme = 'dark' }) => {
  ...
  return (
    <div className="w-full max-w-4xl overflow-x-auto pb-4" dir="ltr">
      <div className={`flex flex-col gap-2 p-4 md:p-6 rounded-[2rem] shadow-2xl border select-none min-w-[320px] transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-slate-200 shadow-slate-200'}`}>
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    rounded-lg md:rounded-xl font-bold text-xs sm:text-sm md:text-xl transition-all duration-100
                    ${isActive 
                      ? 'bg-amber-500 text-gray-900 scale-105 shadow-lg shadow-amber-500/40 ring-4 ring-amber-500/20' 
        ...
        <div className="flex justify-center mt-4">
          <div 
            className={`
              w-40 sm:w-56 md:w-72 h-11 md:h-14 flex items-center justify-center 
